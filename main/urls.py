...
from .views import (index, my_tests, create_test, create_question, update_test, detail_test,
                    update_question, ready_to_test, test, check_test, my_results, results)
...
urlpatterns = [
    ...
    path("update_test/<uuid:test_id>/", update_test, name="update_test"),
    path("detail_test/<uuid:test_id>/", detail_test, name="detail_test"),
