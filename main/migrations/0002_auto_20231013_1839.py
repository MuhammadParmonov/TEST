# Generated by Django 3.2 on 2023-10-13 13:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='question',
            name='test',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.test', verbose_name='test'),
        ),
        migrations.AlterField(
            model_name='question',
            name='true_answer',
            field=models.CharField(max_length=250, verbose_name="to'g'ri javob javob"),
        ),
        migrations.AlterField(
            model_name='test',
            name='author',
        ...
        migrations.AlterField(
            model_name='test',
            name='end_date',
            field=models.DateTimeField(default=datetime.datetime(2023, 10, 15, 13, 39, 48, 274774, tzinfo=utc), verbose_name='tugatish sanasi'),
        ),
        migrations.AlterField(
            model_name='test',
            name='max_attemps',
